...
% --- Motivation ---
% corresponds to: Introduction, motivation in main text
...
% --- Motivation Example ---
% corresponds to: Figure 1 in main text, ransomware motivating example
\begin{frame}{Motivating Example: Distributed Ransomware Detection}
\centering
\includegraphics[width=0.8\textwidth]{figures/safety_agent.pdf}
...
% --- Method: Core Framework Overview ---
% corresponds to: Method overview/Algorithm 1
...
% --- Method Details: Problem Setup ---
% corresponds to: Method overview, problem setup subsection
...
% --- Method Details: Embedding/Clustering/Agentic Search ---
% corresponds to: Method details, clustering, agentic search
...
% --- Method Details: Algorithm Pseudocode ---
% corresponds to: Algorithm 1 (pseudocode)
...
% --- Experimental Method ---
% corresponds to: Experiments, Setup subsection
...
% corresponds to: Table 1, dataset and setup description
...
% corresponds to: PR curves for main results, Figures
\begin{frame}{Experimental Results: Violation Detection}
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/dm_combined_paper_pr_curves.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/safety_impossiblebench_combined_pr_curves.pdf}
...
% --- Ablation Experiment ---
% corresponds to: Ablation study section
...
% --- Deficiencies ---
% corresponds to: Deficiency and adaptive attacks
...
% corresponds to: Adaptive attack evaluation figure
\begin{frame}{Deficiencies: Adaptive Attacks and Performance}
\centering
\includegraphics[width=0.8\textwidth]{figures/dm_adaptive_attacks_pr_curves_with_persona_horizontal.pdf}
...
% --- Future Research ---
% corresponds to: Future work/applications
